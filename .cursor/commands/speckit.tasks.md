...
2. **加载设计文档**: 从 FEATURE_DIR 读取: 
   ...
   **同时加载技术栈文档**: 读取 `.specify/memory/tech-stack.md` 作为技术参考:
   - 确保所有任务使用的技术栈与文档定义一致
...
3. **执行任务生成工作流**:
   ...
   - **参考技术栈文档** (`.specify/memory/tech-stack.md`): 
     - 验证 plan.md 中的技术选择与技术栈文档一致
     - 使用技术栈文档中定义的项目结构约定
     - 使用技术栈文档中定义的构建工具、测试框架等
...
**技术栈一致性**: 所有任务必须使用 `.specify/memory/tech-stack.md` 中定义的技术栈:
   - 前端任务使用 Vue3 + TypeScript + PrimeVue + Pinia
